...
tape('parse, stringify', function (t) {
  ...
  t.equal(ws.stringify('device'), 'ws://localhost:4849')
  t.equal(shs.stringify(), 'shs:' + keys.publicKey.toString('base64'))
  t.equal(
...
tape('onion plug', function (t) {
  ...
  t.deepEqual(onion.parse('onion:3234j5sv346bpih2.onion:2349'), {
    name: 'onion',
